...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('lamenews', ['Post'])

        # Adding M2M table for field tags on 'Post'
        m2m_table_name = db.shorten_name('lamenews_post_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('post', models.ForeignKey(orm['lamenews.post'], null=False)),
            ('tag', models.ForeignKey(orm['lamenews.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['post_id', 'tag_id'])

        # Adding model 'Tag'
        db.create_table('lamenews_tag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal('lamenews', ['Tag'])


    def backwards(self, orm):
        # Deleting model 'Post'
        db.delete_table('lamenews_post')

        # Removing M2M table for field tags on 'Post'
        db.delete_table(db.shorten_name('lamenews_post_tags'))

        # Deleting model 'Tag'
        db.delete_table('lamenews_tag')
