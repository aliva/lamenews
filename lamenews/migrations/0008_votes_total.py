...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        Post = orm['lamenews.Post']
        for post in Post.objects.all():
            post.vote_total = post.vote_ups - post.vote_downs
            post.save()
    ...
    models = {
        ...
        u'lamenews.comment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lamenews.Post']"}),
        ...
        u'lamenews.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['lamenews.Tag']", 'symmetrical': 'False'}),
            ...
            'vote_total': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
